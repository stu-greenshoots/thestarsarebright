...
if ( ! class_exists( 'Hustle_Modules_Common_Admin_Ajax' ) ) :
	...
	class Hustle_Modules_Common_Admin_Ajax {
		 ...
		 * @throws Exception
		 */
		private function action_duplicate_module( Hustle_Model $module ) {
		...
		private function action_delete_module( $module, $context ) {
			...
			$page = 'listing' === $context ? Hustle_Data::get_listing_page_by_module_type( $module->module_type ) : Hustle_Data::ADMIN_PAGE;
		 ...
		 * @throws Exception
		 */
		private function action_reset_tracking( Hustle_Model $module ) {
