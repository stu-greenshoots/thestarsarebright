...
{return(e.which==1||e.which==13||e.which==32||e.which==undefined)?true:false;}};})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5f917d8d73ed0',defaultItem:1,labelIcon:'fas fa-plus',activeIcon:'fas fa-minus',});});})(jQuery);